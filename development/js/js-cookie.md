...
<table class="lamp"> <tbody> <tr> <th style="width:34px"> <img src="/images/lamp.jpg" alt="Note" style="height:32px; width:32px"> </th> <td> document.cookie 将以字符串的方式返回所有的 cookie, 类型格式: cookie1= value; cookie2= value; cookie3= value; </td> </tr> </tbody> </table>
...
[尝试一下 »](/try/tryit.php? filename= tryjs_cookie_username)
